...
> put four spots west or north of the ward polygon, where SRTM reads 0 m:
> Worli Sea Face (9), Worli Village (16), Jamshedji Tata Road (21) and Worli
> Dairy (29). Each was moved to the nearest point lying 100 m inside
...
> **Adjacent spots outside the ward.** The ward boundary is administrative. Ten
> tracked spots sit just outside the polygon: Hindmata Junction, Prabhadevi
> Junction, Currey Road, Parel TT, Dr Ambedkar Road Prabhadevi, Sane Guruji
> Marg, Prabhadevi Chowpatty, Curry Road Bridge Approach, Tulsi Pipe Road and
> Sayani Road Prabhadevi. They are kept as chronic spots on the ward's edge.
> Whether each shares G/South's drainage catchment has not been verified.
> `data_loader/load_flood_spots.py` skips spots outside the polygon, so a fresh
> database loads 20 of the 30; these ten survive only on a database that already
> holds them.
